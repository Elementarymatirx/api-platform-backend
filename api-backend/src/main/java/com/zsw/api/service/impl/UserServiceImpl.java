...
import com.zsw.api.utils.AuthPhoneNumberUtil;
import com.zsw.api.utils.SmsUtils;
...
import com.zsw.common.model.dto.SmsDTO;
import com.zsw.common.model.dto.user.UserRegisterRequest;
import com.zsw.common.model.entity.User;
import com.zsw.common.model.vo.UserDevKeyVO;
...
import static com.zsw.common.constant.CookieConstant.COOKIE_USER_KEY;
import static com.zsw.common.constant.UserConstant.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
    private static final String SALT = "putongxuesheng";
    ...
    public User initLoginUser(User originUser, HttpServletResponse response) {
        ...
        String sign = JWT.create()
                ...
                .setSigner(JWTSignerUtil.hs256("zsw".getBytes()))
    ...
    public UserVO getLoginUser(String cookie) {
        ...
        try {
            JWTValidator.of(jwt).validateAlgorithm(JWTSignerUtil.hs256("zsw".getBytes())).validateDate();
