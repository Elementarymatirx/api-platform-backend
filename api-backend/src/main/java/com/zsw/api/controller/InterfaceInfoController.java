...
import com.zsw.common.common.*;
import com.zsw.common.constant.CommonConstant;
import com.zsw.common.exception.BusinessException;
import com.zsw.common.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.zsw.common.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.zsw.common.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.zsw.common.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest, HttpServletRequest request) {
        ...
        // 动态调用接口
        Object res = invokeInterfaceInfo(ApiClient.class, interfaceInfo.getMethodName(), userRequestParams, accessKey, secretKey);
        if (res == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
    ...
    private Object invokeInterfaceInfo(Class<?> clientClazz, String methodName, String userRequestParams,
        ...
        try {
            ...
            // 2. 构造出客户端
            ApiClient apiClient = (ApiClient) binApiClientConstructor.newInstance(accessKey, secretKey);
    ...
    public void getSdk(HttpServletResponse response) throws IOException {
        // 获取要下载的文件
        org.springframework.core.io.Resource resource = new ClassPathResource("api-sdk-0.0.1.jar");
